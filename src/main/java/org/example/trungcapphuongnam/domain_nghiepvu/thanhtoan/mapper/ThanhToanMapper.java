package org.example.trungcapphuongnam.domain_nghiepvu.thanhtoan.mapper;

import org.example.trungcapphuongnam.domain_nghiepvu.thanhtoan.dto.ThanhToanDTO;
import org.example.trungcapphuongnam.domain_nghiepvu.thanhtoan.entity.ThanhToan;
...
public class ThanhToanMapper {
    ...
    public ThanhToan toEntity(ThanhToanDTO dto) {
        ...
        if (dto.getCongNoId() != null) {
            org.example.trungcapphuongnam.domain_nghiepvu.taichinh.entity.CongNo cn = new org.example.trungcapphuongnam.domain_nghiepvu.taichinh.entity.CongNo();
