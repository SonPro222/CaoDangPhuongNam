...
public class LichSuDiemMapper {
    ...
    public LichSuDiem toEntity(LichSuDiemDTO dto) {
        ...
        if (dto.getDiemThanhPhanId() != null) {
            org.example.trungcapphuongnam.domain_nghiepvu.sinhvien.entity.DiemThanhPhan dtp = new org.example.trungcapphuongnam.domain_nghiepvu.sinhvien.entity.DiemThanhPhan();
