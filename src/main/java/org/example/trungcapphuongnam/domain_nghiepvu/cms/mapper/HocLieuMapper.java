...
public class HocLieuMapper {
    ...
    public HocLieu toEntity(HocLieuDTO dto) {
        ...
        if (dto.getGiangVienId() != null) {
            org.example.trungcapphuongnam.domain_nghiepvu.giaovien.entity.GiangVien gv = new org.example.trungcapphuongnam.domain_nghiepvu.giaovien.entity.GiangVien();
