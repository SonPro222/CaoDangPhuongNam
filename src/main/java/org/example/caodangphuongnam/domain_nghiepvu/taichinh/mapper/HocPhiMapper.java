...
import org.example.caodangphuongnam.domain_nghiepvu.taichinh.dto.HocPhiDTO;
import org.example.caodangphuongnam.domain_nghiepvu.taichinh.entity.HocPhi;
...
public class HocPhiMapper {
    ...
    public HocPhi toEntity(HocPhiDTO dto) {
        ...
        if (dto.getChuongTrinhId() != null) {
            org.example.caodangphuongnam.domain_nghiepvu.khoahoc.entity.ChuongTrinh ct = new org.example.caodangphuongnam.domain_nghiepvu.khoahoc.entity.ChuongTrinh();
            ct.setId(dto.getChuongTrinhId()); entity.setChuongTrinh(ct);
        }
        if (dto.getKyHocId() != null) {
            org.example.caodangphuongnam.domain_nghiepvu.khoahoc.entity.KyHoc kh = new org.example.caodangphuongnam.domain_nghiepvu.khoahoc.entity.KyHoc();
