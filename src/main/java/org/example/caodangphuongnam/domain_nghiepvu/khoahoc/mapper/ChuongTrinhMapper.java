...
import org.example.caodangphuongnam.domain_nghiepvu.khoahoc.dto.ChuongTrinhDTO;
...
public class ChuongTrinhMapper {
    ...
    public ChuongTrinh toEntity(ChuongTrinhDTO dto) {
        ...
        if (dto.getNganhId() != null) {
            org.example.caodangphuongnam.domain_nghiepvu.nganh.entity.Nganh nganh = new org.example.caodangphuongnam.domain_nghiepvu.nganh.entity.Nganh();
